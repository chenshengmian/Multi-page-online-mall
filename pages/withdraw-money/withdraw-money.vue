			...
			<el-menu  class="el-menu-vertical-demo asos" :collapse="isCollapse"
				...
				<el-submenu index="1">
					...
					<el-menu-item-group>
						...
						<el-menu-item  @tap="handlepurchasehistory">{{$t('menu.ewallethistory')}}</el-menu-item>
						<el-menu-item  @tap="handlewithdraw">{{$t('menu.ewalletwithdrawals')}}</el-menu-item>
						<el-menu-item  @tap="handlewithdrawStatus">{{$t('menu.ewalletwithdrawalstatus')}}</el-menu-item>
						<el-menu-item  @tap="handlebonus">{{$t('menu.bonuseshelp')}}</el-menu-item>
						<el-menu-item  @tap="handlekycgo">KYC</el-menu-item>
					</el-menu-item-group>
				</el-submenu>
